...
module adn_axi_pmi_to_axil #(
  ...
  localparam int STRB_WIDTH = $bits(s_pmi_req.mstrb);
  ...
  assign m_axil_req.aw.addr = s_pmi_req.maddr;
  assign m_axil_req.ar.addr = s_pmi_req.maddr;
  assign m_axil_req.aw.prot = 3'b000;
  assign m_axil_req.ar.prot = 3'b000;
 
  assign aw_valid_i  = req_fire &  s_pmi_req.mwe;
  assign ar_valid_i  = req_fire & ~s_pmi_req.mwe;
 
  assign m_axil_req.w.data = s_pmi_req.mwdata;
  assign m_axil_req.w.strb = s_pmi_req.mstrb;
  ...
  assign write_hs_done = (aw_seen_q | m_axil_rsp.aw_ready) &
                         (w_seen_q | m_axil_rsp.w_ready) & aw_valid_i;
  ...
  assign s_pmi_rsp.mresp  = op_type_head ? m_axil_rsp.b.rsp : m_axil_rsp.r.rsp;
